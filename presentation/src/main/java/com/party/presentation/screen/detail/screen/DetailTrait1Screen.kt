...
fun DetailTraitRoute1(
    ...
    DetailTraitScreen1(
        ...
        onGotoNext = { navController.navigate(route = Screens.DetailTrait2)},
        onClose = { viewModel.onAction(action = DetailProfileAction.OnShowFinishDialog(isShow = true))},
        onSkip = { navController.navigate(route = Screens.DetailTrait2)}
    )
}

@Composable
private fun DetailTraitScreen1(
    snackBarHostState: SnackbarHostState,
        ...
        Column(
            ...
            Column(
                ...
                Trait1Section(
                    ...
                    onSelect = { onAction(DetailProfileAction.OnSelectTrait1(it))}
                )
            }
