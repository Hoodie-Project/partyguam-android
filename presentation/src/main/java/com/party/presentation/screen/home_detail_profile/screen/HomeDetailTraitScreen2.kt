...
fun HomeDetailTraitRoute2(
    ...
    HomeDetailTraitScreen2(
        snackBarHostState = snackBarHostState,
        onNavigationClick = { navController.popBackStack() },
        state = state,
        onAction = { action -> viewModel.onAction(action = action)},
        onGotoNext = { navController.navigate(route = Screens.Trait3)},
        onClose = { viewModel.onAction(action = HomeDetailProfileAction.OnShowFinishDialog(isShow = true))},
        onSkip = { navController.navigate(route = Screens.Trait3)}
    )
}

@Composable
private fun HomeDetailTraitScreen2(
    snackBarHostState: SnackbarHostState,
        ...
        Column(
            ...
            Column(
                ...
                Trait2Section(
                    ...
                    onSelect = { onAction(HomeDetailProfileAction.OnSelectTrait2(it))}
                )
            }
